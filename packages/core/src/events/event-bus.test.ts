...
describe('EventBus', () => {
  ...
  describe('Event Subscription', () => {
    ...
    it('should respect handler priority', () => {
      ...
      eventBus.subscribe('test.event', () => { callOrder.push(3) }, { priority: 0 })
      eventBus.subscribe('test.event', () => { callOrder.push(1) }, { priority: 10 })
      eventBus.subscribe('test.event', () => { callOrder.push(2) }, { priority: 5 })
  ...
  describe('Error Handling', () => {
    it('should continue on sync handler errors', () => {
      ...
      const handler1 = mock.fn(() => { throw new Error('Handler 1 error') })
      const handler2 = mock.fn()
