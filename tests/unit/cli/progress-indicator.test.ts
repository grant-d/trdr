...
import { MultiProgress, ProgressIndicator, Spinner } from '../../../src/cli/progress-indicator'
...
describe('Progress Indicator', () => {
  describe('ProgressIndicator', () => {
    ...
    it('should throttle updates', () => {
      ...
      const lines = stdoutOutput
        .split('\r')
        .filter((line) => line.includes('1/100'))
  ...
  describe('Spinner', () => {
    it('should cycle through frames', async () => {
      ...
      ok(
        output.includes('1') || output.includes('2') || output.includes('3'),
        'Should include at least one frame'
      )
    })
