...
import type { ConfigOverrideError } from '../../../src/cli/config-overrides'
...
describe('Config Overrides', () => {
  describe('applyOverrides', () => {
    ...
    it('should handle null and undefined values', () => {
      ...
      applyOverrides(config, ['input.symbol=null', 'input.exchange=undefined'])
  ...
  describe('error handling', () => {
    it('should throw error for invalid syntax - missing equals', () => {
      ...
      throws(
        ...
        (error: ConfigOverrideError) => {
          ...
          ok(
            error.message.includes("Expected format: 'path.to.property = value'")
          )
          return true
        }
      )
    ...
    it('should throw error for invalid input property', () => {
      ...
      throws(
        ...
        (error: ConfigOverrideError) => {
          ok(
            error.message.includes("Invalid input property 'invalidProperty'")
          )
          return true
        }
      )
    ...
    it('should throw error for invalid output property', () => {
      ...
      throws(
        ...
        (error: ConfigOverrideError) => {
          ok(
            error.message.includes("Invalid output property 'invalidProperty'")
          )
          return true
        }
      )
    ...
    it('should throw error for invalid transformation index', () => {
      ...
      throws(
        ...
        (error: ConfigOverrideError) => {
          ok(
            error.message.includes("Invalid transformation index 'notAnIndex'")
          )
          return true
        }
      )
    ...
    it('should throw error for invalid transformation property', () => {
      ...
      throws(
        ...
        (error: ConfigOverrideError) => {
          ok(
            error.message.includes("Invalid transformation property 'invalid'")
          )
          return true
        }
      )
    ...
    it('should throw error for invalid options property', () => {
      ...
      throws(
        ...
        (error: ConfigOverrideError) => {
          ok(
            error.message.includes("Invalid options property 'invalidOption'")
          )
          return true
        }
      )
    ...
    it('should throw error for invalid metadata property', () => {
      ...
      throws(
        ...
        (error: ConfigOverrideError) => {
          ok(
            error.message.includes("Invalid metadata property 'invalidField'")
          )
          return true
        }
      )
        ...
        (error: ConfigOverrideError) => {
          ok(
            error.message.includes(
              "Invalid column mapping field 'invalidField'"
            )
          )
          return true
        }
  ...
  describe('type conversion', () => {
    it('should convert string numbers to integers', () => {
      ...
      applyOverrides(config, ['input.chunkSize=2000', 'options.maxErrors=50'])
  ...
  describe('getConfigValue', () => {
    it('should retrieve nested configuration values', () => {
      ...
      strictEqual(
        getConfigValue(config, 'input.columnMapping.timestamp'),
        'ts'
      )
    ...
    it('should return undefined for non-existent paths', () => {
      ...
      strictEqual(
        getConfigValue(config, 'input.columnMapping.nonexistent'),
        undefined
      )
    })
    ...
    it('should handle null and undefined intermediate values', () => {
      ...
      strictEqual(
        getConfigValue(config, 'undefinedProperty.nested'),
        undefined
      )
    })
  })
  ...
  describe('integration tests', () => {
    it('should apply comprehensive overrides correctly', () => {
      ...
      strictEqual(config.transformations[0]?.disabled, true)
      strictEqual(
        (config.transformations[0]?.params as any).priceField,
        'close'
      )
