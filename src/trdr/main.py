...
def main() -> None:
    ...
    # Legacy command (default)
    subparsers.add_parser("run", help="Run legacy trading bot")

    # Live command
    live_parser = subparsers.add_parser("live", help="Run live trading with new harness")
    live_parser.add_argument("--ui", action="store_true", help="Enable TUI dashboard")
    live_parser.add_argument("--symbol", type=str, help="Trading symbol (e.g., crypto:ETH/USD)")
